...
@section('content')
    {{-- Aqui creo un formulario para crear las ofertas --}}
    <div-card>
        <div class="card-body">
            {!! Form::open(['route' => 'offer.store', 'autocomplete' => 'off', 'files' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Descripcion del articulo: ']) !!}
                </div>
