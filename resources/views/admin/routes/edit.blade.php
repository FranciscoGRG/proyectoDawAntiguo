...
@section('content')
    {{-- Aqui creo un formulario para editar una ruta que haya creado el usuario logeado --}}
    <div-card>
        <div class="card-body">
            {!! Form::model($route,['route' => ['route.update', $route], 'method' => 'put', 'autocomplete' => 'off', 'files' => 'true']) !!}
